...
from tokenizers.trainers import WordLeverlTrainer
...
def get_or_build_tokenizer(config, ds, lang):
    ...
    if not Path.exists(tokenizer_path):
        ...
        trainer = WordLeverlTrainer(special_tokes=["[UNK]", "[PAD]", "[SOS]", "[EOS]"], min_frquency=2)
...
def train_model(config):
    ...
    if config['preload']:
        ...
        optimizer.load_stat_dict(state['optimizer_state_dict'])
